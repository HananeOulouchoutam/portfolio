      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am a Junior Full-Stack Developer specializing in the MERN stack. I
            build modern web applications using MongoDB, Express, React, and
            Node.js. I am passionate about learning, improving my skills, and
            creating clean, responsive, and efficient digital solutions.
          </p>
